...
public class LiveMessageTesting
{
    ...
    public void WritingLiveHistory()
    {
        ...
        {
            ConsoleExt.WriteLine($"Message: {e.Message} StackTrace: {e.StackTrace}", ConsoleExt.CurrentStep.FileReading, ConsoleExt.OutputType.Error, e, true, true);
    ...
    public void WritingPaginatedLiveHistory()
    {
        ...
        {
            ConsoleExt.WriteLine(e.Message, ConsoleExt.CurrentStep.FileReading, ConsoleExt.OutputType.Error, e, true, true);
